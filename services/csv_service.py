    ...
    for score_data in standard_scores:
        ...
        if diem_thpt and diem_thpt >= diem_chuan_float:
            suggestions.append({
                ...
                'match_type': 'thpt',
                'confidence': min(1.0, (diem_thpt - diem_chuan_float) / diem_chuan_float + 1.0)
            })
        ...
        if diem_tsa and diem_tsa >= diem_chuan_float:
            suggestions.append({
                ...
                'nam': score_data.get('nam'),
                'match_type': 'tsa',
                'confidence': min(1.0, (diem_tsa - diem_chuan_float) / diem_chuan_float + 1.0)
            })
        ...
        if diem_dgnl and diem_dgnl >= diem_chuan_float:
            suggestions.append({
                ...
                'nam': score_data.get('nam'),
                'match_type': 'dgnl',
                'confidence': min(1.0, (diem_dgnl - diem_chuan_float) / diem_chuan_float + 1.0)
            })
...
def handle_intent_query(analysis: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
    """
